                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                <button type="button" class="btn btn-warning btn-sm edit-btn" onclick="window.location.href='waiter/editMenu.php?idMenu=<?php echo $row['idMenu']; ?>'" data-id="<?php echo $row['idMenu']; ?>" data-nama="<?php echo $row['namaMenu']; ?>" data-harga="<?php echo $row['harga']; ?>">Edit</button>
                                    <!-- Modal Delete -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="waiter/hapusMenu.php?idMenu=<?php echo $row['idMenu']; ?>" class="btn btn-danger btn-circle">
