    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <h3 class="text-primary"><i class="fas fa-bowl-food me-2"></i>Sushilicious</h3>
                </a>
                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    ?>
                            ...
                            <td>Rp. <?php echo number_format($row['bayar'], 0, ',', '.'); ?></td>
                                <td>
                                <button type="button" class="btn btn-warning btn-sm edit-btn" onclick="window.location.href='editTransaksi.php?idTransaksi=<?php echo $row['idTransaksi']; ?>'" data-id="<?php echo $row['idTransaksi']; ?>" data-menu="<?php echo $row['idTransaksi']; ?>">Edit</button>
                                    <!-- Modal Delete -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="hapusTransaksi.php?idTransaksi=<?php echo $row['idTransaksi']; ?>" class="btn btn-danger btn-circle">
